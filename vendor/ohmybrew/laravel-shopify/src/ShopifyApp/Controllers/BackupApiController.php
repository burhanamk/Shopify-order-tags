    ...
    public function ProcessOrder($orderProducts, $shop)
    {
        foreach ($orderProducts['productsDetails'] as $orderRequired) {
            ...
            if ($ActualREQUIRED) {
              ...
              'logmsg'=>"Insufficient quantit of product : Order Number ".$orderProducts['ordernum'].", Product Id :".$orderRequired['productId'].", Variant Id :".$orderRequired['variantId'].", Quantity :".$orderRequired['quantity_orderd']
              ];
